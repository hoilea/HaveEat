...
object Progress {
    ...
    fun show(context: Context, @LayoutRes layoutRes: Int = R.layout.dialog_progress, isCancelable : Boolean = false, cancelListener : DialogInterface.OnCancelListener? = null) {
        dismiss()
