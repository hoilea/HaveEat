...
fun RecyclerView.setSpace(spaceV: Int, spaceH: Int) {
    addItemDecoration(SpacesItemDecoration(spaceV, spaceH));
}

private class SpacesItemDecoration(private val spaceV: Int, private val spaceH: Int) : ItemDecoration() {
